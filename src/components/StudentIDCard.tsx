  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden">
        ...
        {/* ID Card Content */}
        <div className="p-6" id="student-id-card">
          {/* Front Side */}
          <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl p-6 border-2 border-blue-200 shadow-lg mb-6">
            {/* School Header */}
            <div className="text-center mb-6">
              <div className="flex items-center justify-center space-x-4 mb-3">
                ...
                />
                <div>
                  <h1 className="text-lg font-bold text-blue-900">{state.schoolInfo.name}</h1>
          ...
          {/* Back Side */}
          <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-xl p-6 border-2 border-gray-200 shadow-lg">
            ...
            <div className="space-y-4 text-sm">
              ...
              <div>
                ...
                <p className="text-gray-700">Email: {state.schoolInfo.email}</p>
